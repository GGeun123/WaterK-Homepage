...
<body>
<form method="post" action="board_modify.php?number=<?=$number?>">
  ...
  <div class="wrap">
    <div class="container">
      <div class="contact">
        ...
        <form action="./board_modify.php?number=<?$number; ?>" method="post">
          <table class="table">
            ...
            <tr>
              ...
              <td class="table-info"><input class="form-control" type="text" name="name" value="<?=$row['id']?>"></td>
            </tr>
            <tr>
            ...
            <tr class="form-email">
              ...
              <td class="table-info"><input class="form-control" type="text" name="tel" value="<?=$row['tel']?>"></td>
            </tr>
            <tr class="form-email">
              <td class="table-title">이메일</td>
              <td class="table-info"><input class="form-control" type="text" name="email" value="<?=$row['email']?>"></td>
            </tr>
          </table>
          <div class="form-btn">
